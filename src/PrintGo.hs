...
instance Print TopDef where
  prt i e = case e of
    FnDef id args types block -> prPrec i 0 (concatD [prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 types, prt 0 block])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print Arg where
  prt i e = case e of
    Arg id type_ -> prPrec i 0 (concatD [prt 0 id, prt 0 type_])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
...
instance Print Stmt where
  prt i e = case e of
    ...
    Decl items type_ -> prPrec i 0 (concatD [doc (showString "var"), prt 0 items, prt 0 type_, doc (showString ";")])
